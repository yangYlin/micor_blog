...
class UserModelCase(unittest.TestCase):
    def setUp(self):  # 执行前
        ...
        app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:mysql@127.0.0.1:3306/test'  # 内存中的数据库
        db.create_all()

    def tearDown(self):  # 每个方法执行后
        db.session.remove()
        db.drop_all()
    ...
    def test_password_hashing(self):
        ...
        u.set_password('cat')
        self.assertFalse(u.check_password('dog'))  # 断言应该是o
        self.assertTrue(u.check_password('cat'))  # 断言应该是1 正确
